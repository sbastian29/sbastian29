...
<img src="https://komarev.com/ghpvc/?username=sbastian29&style=flat-square&color=2c5364&label=Visitas"/>
...
|:--|:--|:--|
| **[Predicción de Churn (TFM)](https://github.com/sbastian29/Proyecto-Final---Marzo-2025---PER-12782)** | Arquitectura Big Data end-to-end para predecir el abandono de clientes: ingesta en streaming, procesamiento distribuido y persistencia. | `Kafka` · `Spark` · `PostgreSQL` · `Docker` |
...
| Proyecto | Descripción | Stack |
|:--|:--|:--|
| **[Modelado de Churn](https://github.com/sbastian29/Proyecto-Final---Marzo-2025---PER-12782)** | Modelos de clasificación (árbol de decisión, random forest) para anticipar la fuga de clientes, con visualización de resultados. | `Python` · `KNIME` · `Power BI` |
...
| Proyecto | Descripción | Stack |
|:--|:--|:--|
| **[Portfolio Personal](https://github.com/sbastian29/sebastiancastano.dev)** | Portfolio bilingüe (ES/EN) con animaciones 3D, scroll interactivo y cursores personalizados. | `Three.js` · `GSAP` · `HTML` |
| **[Educa](https://github.com/sbastian29/Educa)** | Proyecto web desarrollado en TypeScript. | `TypeScript` |

</details>

<details>
<summary>&nbsp;<b>RPA & Automatización</b></summary>
<br/>

| Proyecto | Descripción | Stack |
|:--|:--|:--|
| **[UIPath_Prueba](https://github.com/sbastian29/UIPath_Prueba)** | Automatización de procesos con RPA. | `UiPath` |
